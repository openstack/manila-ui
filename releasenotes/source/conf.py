...
# manila-ui Release Notes documentation build configuration file,
...
manila_ui_version = pbr.version.VersionInfo('manila_ui')


release = manila_ui_version.version_string_with_vcs()
# The short X.Y version.
version = manila_ui_version.canonical_version_string()
