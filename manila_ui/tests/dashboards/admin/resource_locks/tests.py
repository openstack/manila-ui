...
INDEX_URL = reverse('horizon:admin:resource_locks:index')


class ResourceLocksViewTests(test.BaseAdminViewTests):
    ...
    def test_update_lock_get(self):
        ...
        url = reverse('horizon:admin:resource_locks:update', args=[lock.id])
