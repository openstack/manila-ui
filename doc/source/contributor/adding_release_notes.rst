...
* A code change that doesn't change the general behavior of any
  feature such as code refactor or logging changes.
* Functional or unit test coverage enhancement
* Changes to the content of an error message displayed on the UI
...
* *add-share-network-create-workflows-41cad17c1498a3.yaml*

.. code-block:: yaml

    ---
    features:
     - switched share network creation into two-step workflows.